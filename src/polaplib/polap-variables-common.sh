...
local _polap_var_outdir_fq_stats="${_polap_var_outdir}/fq.stats.txt"
...
local _polap_var_outdir_nk4_fq_gz="${_polap_var_outdir}/nk4.fq.gz"
local _polap_var_outdir_nk8_fq_gz="${_polap_var_outdir}/nk8.fq.gz"
local _polap_var_outdir_nk16_fq_gz="${_polap_var_outdir}/nk16.fq.gz"
local _polap_var_outdir_nk32_fq_gz="${_polap_var_outdir}/nk32.fq.gz"
