...
source "${_POLAPLIB_DIR}/polap-lib-genomesize.sh"
...
source "${_POLAPLIB_DIR}/polap-lib-salign.sh"
source "${_POLAPLIB_DIR}/polap-cmd-polish.sh"
source "${_POLAPLIB_DIR}/polap-cmd-salign.sh"
