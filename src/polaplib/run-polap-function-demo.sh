...
HEREDOC
	...
	"Spirodela_polyrhiza" | \
		...
		bash ${_POLAPLIB_DIR}/polap-data-v1.sh "${_m2}"
		;;
	"install-conda")
	...
	"link-fastq")
		...
		;;
	"plot")
		pandoc ${_POLAPLIB_DIR}/doc/plot.md -o supp-figure-s11-s32.pdf
		pandoc ${_POLAPLIB_DIR}/doc/plot.md -o supp-figure-s11-s32.docx
		;;
	"table1")
		bash ${_POLAPLIB_DIR}/polap-report-table1.sh >table1.tsv
