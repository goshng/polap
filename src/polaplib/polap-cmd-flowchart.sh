...
EOF
	...
	# chmod +x polap-bash-organelle-assembly-flow.sh
	_polap_lib_conda-ensure_conda_env polap || exit 1
	bash "${_POLAPLIB_DIR}/polap-bash-flowchart-organelle-assembly.sh" -o out -f png --theme dark
	bash "${_POLAPLIB_DIR}/polap-bash-flowchart-organelle-assembly.sh" -o out -f svg --theme dark
	conda deactivate
	# Produces: out/polap_organelle_assembly.gv and out/polap_organelle_assembly.png
