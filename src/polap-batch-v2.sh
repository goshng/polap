...
bash src/polap-data-v2.sh suppfigure1 all 2 infer-1 1 1 no
bash src/polap-data-v2.sh suppfigure1 Eucalyptus_pauciflora 2 infer-1 1 1 no
bash src/polap-data-v2.sh suppfigure3 2 infer-1 on no
bash src/polap-data-v2.sh suppfigure3 2 infer-1 off no
exit
