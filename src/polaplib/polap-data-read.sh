...
EOF
	...
	_polap_lib_conda-ensure_conda_env polap || exit 1
	make SET="$set" -f "${_POLAPLIB_DIR}/Makefile.read" manifest
	conda deactivate
...
man-sheet-ptmt_genus_species() {
	...
	_polap_lib_conda-ensure_conda_env polap || exit 1
	make SET="$set" -f "${_POLAPLIB_DIR}/Makefile.read" sheet-ptmt
	conda deactivate
}
...
man-table-data_genus_species() {
	...
	_polap_lib_conda-ensure_conda_env polap || exit 1
	make SET="$set" -f "${_POLAPLIB_DIR}/Makefile.read" table-data
	conda deactivate
}
...
man-pt-table_genus_species() {
	...
	_polap_lib_conda-ensure_conda_env polap || exit 1
	make SET="$set" -f "${_POLAPLIB_DIR}/Makefile.read" pt-table
	conda deactivate
}
...
man-mt-table_genus_species() {
	...
	_polap_lib_conda-ensure_conda_env polap || exit 1
	make SET="$set" -f "${_POLAPLIB_DIR}/Makefile.read" mt-table
	conda deactivate
}
...
man-mt-figure_genus_species() {
	...
	_polap_lib_conda-ensure_conda_env polap || exit 1
	make SET="$set" -f "${_POLAPLIB_DIR}/Makefile.read" mt-figure
	conda deactivate
}
