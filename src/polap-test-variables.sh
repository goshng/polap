...
common() {
	...
	declare -p _polap_var_output _polap_var_base _polap_var_bioproject _polap_var_wga _polap_var_ga _polap_var_contigger _polap_var_ann _polap_var_mtcontigs _polap_var_mtdna _polap_var_compare MTCONTIGNAME _polap_var_mtcontigname _polap_var_mtcontigs_links _polap_var_oga _polap_var_oga_contigger _polap_var_seeds
}
