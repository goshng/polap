...
bash src/polap-data-v2.sh suppfigure1 all 2 infer-1 x
bash src/polap-data-v2.sh suppfigure1 Eucalyptus_pauciflora 2 infer-1 x
...
bash src/polap-data-v2.sh maintable1 all 0 infer-1 1
