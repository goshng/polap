...
local _timing_txt_base="${_brg_outdir_i}/timing-${_brg_title}"
local _stdout_txt_base="${_brg_outdir_i}/stdout-${_brg_title}"
local _memlog_file_base="${_brg_outdir_i}/memlog-${_brg_title}"
local _summary_file_base="${_brg_outdir_i}/summary-${_brg_title}"
