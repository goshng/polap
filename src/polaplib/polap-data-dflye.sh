...
help_message_example=$(
  ...
  p4 run direct-oga Test_species index:0 inum:0 range:0
  ...
  p4 run direct-read Test_species 0 1 2 range:1
  p4 run direct-flye Test_species 0 1 2 range:1 knum:which-in-the-range

  p4 run direct-dga Test_species index:0 inum:1 jnum:2 range:1
