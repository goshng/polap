...
![Workflow of the subsampling-based plastid genome assembly. The genome assembly procedure is applied repeatedly in Stages 1 and 2.](polap2-figure1.pdf){#fig:mainfigure1 width=100%}
...
![Line plot of increment size versus subsample size index in Stage 1 of the subsampling-based assemblies for _Eucalyptus pauciflora_.](figures/figure-time-some-0.pdf){#fig:time-some-0 width=100%}
...
![Line plot of increment size versus subsample size index in Stage 1 of the subsampling-based assemblies for _Eucalyptus pauciflora_.](figures/figure-memory-some-0.pdf){#fig:memory-some-0 width=100%}
