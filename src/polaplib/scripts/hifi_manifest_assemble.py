#!/usr/bin/env python3
# scripts/hifi_manifest_assemble.sh
#
# Version : v0.2.5
...
# • NEW: Treat assembly-specific organelle blocks (oatk-*, tippo, himt, pmat2):
#     - All attributes for these blocks are stored as *strings* (no coercion).
#     - This ensures your assembly metrics (mem/time/disk/4C) appear in the JSON.
...
def is_assembly_block(org: str) -> bool:
    ...
    block (OATK/TIPPo/HiMT/PMAT2), i.e. attrs retained as strings.
    """
    if not org:
        return False
    org = str(org)
